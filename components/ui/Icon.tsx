...
const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  switch (name) {
    ...
    case 'HeartHandshake':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" /><path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08v0c.82.82 2.13.82 2.94 0l.06-.06L12 11l2.94-2.94a2.17 2.17 0 0 1 3.08 0v0c.82.82.82 2.13 0 2.94l0 0L12 17" /></svg>
        );
    case 'Send':
        return (
    ...
    case 'BrainCircuit':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.993.119" /><path d="M18.675 18.007A3 3 0 1 0 21 15.5" /><path d="M6 15.5a3 3 0 1 0 2.48-.993" /><path d="M14.993 6.01A3 3 0 1 0 12.5 3" /><path d="M4.5 10.5a3 3 0 1 0 2.48-.993" /><path d="M17.5 12.5a3 3 0 1 0 .507 2.493" /><path d="M9.007 18.007A3 3 0 1 0 6.5 15.5" /><path d="M12 12a3 3 0 1 0 .507 2.493" /><path d="m4.5 10.5 1.5 1.5" /><path d="m9.48 11.51 2.04 2.04" /><path d="m14.51 9.48 2.04 2.04" /><path d="M6.01 15.01 7 14" /><path d="m15 6-1 2" /><path d="m18 16 1.5-1.5" /><path d="M12 8V5" /><path d="M12 19v-3" /><path d="M15 3.5v3" /><path d="M9 20.5v-3" /></svg>
        );
    case 'AlertTriangle':
        return (
    ...
    case 'Settings':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2.23l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1 0-2.23l.15-.08a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" /><circle cx="12" cy="12" r="3" /></svg>
        );
    case 'GitMerge':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 9v6c0 2.2 1.8 4 4 4h4"/></svg>
        );
    default:
      return null;
  }
