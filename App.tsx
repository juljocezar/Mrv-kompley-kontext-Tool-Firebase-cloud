...
Antworte im JSON-Format.`;
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            ...
            case 'graph': return <GraphTab entities={caseEntities} documents={documents} caseDescription={caseDescription} settings={settings} logAgentAction={logAgentAction} isLoading={isLoading} setIsLoading={setIsLoading} setLoadingSection={setLoadingSection} />;
